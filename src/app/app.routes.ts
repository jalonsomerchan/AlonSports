...
import { ActivitiesPage, ActivityPage, AppShell, DashboardPage, ImportPage, LiveActivitiesPage, LiveActivityPage, LiveDashboardPage, LiveSegmentsPage, LoginPage, SegmentDetailPage, SegmentsPage, SettingsPage, SharePage } from './app';
...
import { SegmentCreatorPage } from './segment-creator';
...
export const routes: Routes = [
  ...
  { path: 'app', component: AppShell, canActivate: [authGuard], children: [
    ...
    { path: 'segments/new', component: SegmentCreatorPage },
